...
<body>
    ...
    <h1 style="text-align: center;background-color: blue;padding: 20px">选 择 你 要 修 改 的 帖 子</h1>
    <h3><a href="dashboard.php"><--返回个人信息</a></h3>
    <?php
    ...
    while ($rows=mysqli_fetch_object($result) and $j<=$records_per_page){
        echo "<tr>";
        echo "<td><a href='change-mess.php?id=$rows->id'>",$rows->title,"</a></td>";
